...
describe('symmetric-tree', () => {
  ...
  it('should return false when not a symmetric-tree', () => {
    ...
    expect(isSymmetric('recursion')(createBinaryTree([1, 2]))).to.be.false
    expect(isSymmetric('recursion')(createBinaryTree([2, 3, 3, 4, 5, 5, 4, null, null, 8, 9, null, null, 9, 8]))).to.be.false
  })
})
